...
import type { ApiGenerateMeetTokenRequest } from 'mezon-js';
...
const generateMeetTokenCached = async (mezon: MezonValueContext, channelId: string, roomName: string, metadata?: string) => {
	const body: ApiGenerateMeetTokenRequest = {
