import { AvatarImage, GifStickerEmojiPopup, MemberProfile, SearchMessageChannel, StatusFriend } from '@mezon/components';
import { useAppNavigation, useGifsStickersEmoji } from '@mezon/core';
import { selectCloseMenu, selectCurrentUserDM, selectFriendStatus, selectPositionEmojiButtonSmile, selectStatusMenu } from '@mezon/store';
import { Icons } from '@mezon/ui';
import { EmojiPlaces, SubPanelName, createImgproxyUrl, isLinuxDesktop, isWindowsDesktop } from '@mezon/utils';
