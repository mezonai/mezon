...
import { CHANNEL_INPUT_ID, CREATING_THREAD, generateE2eId, IMAGE_MAX_FILE_SIZE, MAX_FILE_ATTACHMENTS, MAX_FILE_SIZE, processFilesForAttachment, UploadLimitReason, ValidateSpecialCharacters } from '@mezon/utils';
...
const ThreadBox = () => {
	...
	return (
		...
		>
			...
			<div
				className={`flex-shrink-0 flex flex-col pb-4 px-3  h-auto relative ${checkAttachment ? 'rounded-t-none' : 'rounded-t-lg'}`}
			>
				<div
