...
export type FileSelectionButtonTopicDiscussionProps = {
    currentClanId: string;
    currentChannelId: string;
    hasPermissionEdit: boolean;
};

function FileSelectionButtonTopicDiscussion({ currentClanId, currentChannelId, hasPermissionEdit }: FileSelectionButtonTopicDiscussionProps) {
    ...
    return (
        <label className="pl-3 flex items-center h-11">
            <input id="topic_preview_img" type="file" onChange={handleChange} className="w-full hidden" multiple />
...
export default FileSelectionButtonTopicDiscussion; 