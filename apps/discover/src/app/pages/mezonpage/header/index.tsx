...
const NavItem = memo(({ to, section, label, onClick }: NavLinkProps) => (
	<Link
		...
		className="relative text-[13px] lg:text-[14px] xl:text-[15px] 2xl:text-[16px] leading-[24px] text-white font-semibold flex flex-row items-center px-1.5 lg:px-2 2xl:px-3 py-2 rounded-lg transition-all duration-300 group overflow-hidden whitespace-nowrap flex-shrink-0"
...
const HeaderMezon = memo((props: HeaderProps) => {
	...
	return (
		...
		>
			<div
				className="w-[95%] 2xl:w-10/12 max-w-[1440px] max-md:border-b-[1px] max-md:border-[#4465FF4D] h-full"
				data-e2e={generateE2eId('homepage.header.container.navigation')}
			>
				<div className="flex items-center justify-between md:px-[10px] xl:px-4 2xl:px-[32px] h-full gap-2 xl:gap-4">
					<div className="hidden lg:flex items-center flex-shrink-0 min-w-fit 2xl:min-w-[260px]">
					...
					<nav className="hidden lg:flex items-center justify-center flex-1 min-w-0 gap-x-1 xl:gap-x-1.5 2xl:gap-x-2">
					...
					<div className="flex items-center justify-end gap-1.5 lg:gap-2 xl:gap-3 2xl:gap-4 flex-shrink-0 min-w-fit 2xl:min-w-[260px] ml-auto">
						<a
							href={isLogin ? `${process.env.NX_CHAT_APP_REDIRECT_URI}/meet` : `${process.env.NX_CHAT_APP_REDIRECT_URI}/mezon`}
							className="hidden lg:flex items-center px-3 xl:px-4 2xl:px-[20px] py-[8px] 2xl:py-[10px] bg-white/10 border border-white/20 backdrop-blur-sm rounded-xl text-white text-[13px] lg:text-[14px] 2xl:text-[16px] font-bold whitespace-nowrap hover:bg-[#de82e6] hover:border-[#de82e6] hover:scale-105 active:scale-95 transition-all duration-300 shadow-sm"
						>
						...
						<a
							...
							className="hidden lg:flex items-center px-3 xl:px-4 2xl:px-[20px] py-[8px] 2xl:py-[10px] bg-white rounded-xl text-[#6E4A9E] text-[13px] lg:text-[14px] 2xl:text-[16px] font-bold whitespace-nowrap hover:shadow-[0_0_15px_rgba(255,255,255,0.4)] hover:scale-105 active:scale-95 transition-all duration-300"
