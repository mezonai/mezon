				...
				<View style={styles.heroContainer}>
					...
					<View style={styles.headerOverlay}>
						<TouchableOpacity onPress={handleBack} style={styles.headerButton}>
							<MezonIconCDN icon={IconCDN.arrowLargeLeftIcon} width={size.s_32} height={size.s_32} color="white" />
						</TouchableOpacity>
						<View style={styles.headerRight}>
							<TouchableOpacity onPress={handleShare} style={styles.headerButton}>
								<MezonIconCDN icon={IconCDN.shareIcon} width={size.s_24} height={size.s_24} color="white" />
							</TouchableOpacity>
							<TouchableOpacity onPress={handleMenu} style={styles.headerButton}>
								<MezonIconCDN icon={IconCDN.moreVerticalIcon} width={size.s_24} height={size.s_24} color="white" />
							</TouchableOpacity>
						</View>
					</View>
					...
					<View style={styles.titleOverlay}>
						...
						<View style={styles.dateTimeRow}>
							<MezonIconCDN icon={IconCDN.calendarIcon} width={size.s_16} height={size.s_16} color="white" />
				...
				<View style={styles.content}>
					...
					<View style={styles.actionButtons}>
						<TouchableOpacity style={[styles.goingButton, isGoing && styles.goingButtonActive]} onPress={handleToggleGoing}>
							<MezonIconCDN
								icon={isGoing ? IconCDN.checkmarkSmallIcon : IconCDN.circleQuestionIcon} // closest approximation to check-circle/outline
								width={size.s_20}
								height={size.s_20}
								color="white"
							/>
						...
						<TouchableOpacity style={styles.addPhotosButton} onPress={handleAddPhotos}>
							<MezonIconCDN icon={IconCDN.cameraIcon} width={size.s_20} height={size.s_20} color="white" />
					...
					<View style={styles.infoSection}>
						<View style={styles.infoIconContainer}>
							<MezonIconCDN icon={IconCDN.clockIcon} width={size.s_24} height={size.s_24} color="#8B5CF6" />
						</View>
					...
					{params.location && (
						<View style={styles.infoSection}>
							<View style={styles.infoIconContainer}>
								<MezonIconCDN icon={IconCDN.locationIcon} width={size.s_24} height={size.s_24} color="#8B5CF6" />
							</View>
							<View style={styles.infoContent}>
								...
								<View style={styles.mapPreview}>
									<MezonIconCDN icon={IconCDN.locationIcon} width={size.s_48} height={size.s_48} color="#666680" />
					...
					<View style={styles.discussionSection}>
						<View style={styles.discussionHeader}>
							<MezonIconCDN icon={IconCDN.discussionIcon} width={size.s_24} height={size.s_24} color="#8B5CF6" />
